...
def generate_pdf(df, title="Laporan KasKita"):
    ...
    t.setStyle(TableStyle([
        ...
        ("ROWBACKGROUNDS", (0, 1), (-1, -1),
         [colors.white, colors.HexColor("#F3FDF9")]),
...
def render_logo_sidebar():
    ...
    <div style="display:flex;align-items:center;gap:10px;padding:0.5rem 0.25rem 1rem;">
        <div style="width:34px;height:34px;background:#09F289;border-radius:9px;
            ...
            <svg width="19" height="19" viewBox="0 0 22 22" fill="none">
                <rect x="2" y="6" width="18" height="11" rx="2.5"
                      stroke="#01023B" stroke-width="1.7"/>
        ...
        <div>
            <div style="font-size:15px;font-weight:600;color:#FFFFFF;line-height:1.1;">
                KasKita
            </div>
            <div style="font-size:10px;color:rgba(9,242,137,0.6);">
                Manajemen kas kelas
            </div>
        </div>
    </div>
...
def render_class_chip(kls, jrs):
    st.markdown(f"""
    <div style="background:rgba(9,242,137,0.1);
                border:1px solid rgba(9,242,137,0.22);
                border-radius:8px;padding:8px 10px;margin-bottom:1rem;">
        <div style="font-size:10px;color:#09F289;font-weight:500;letter-spacing:.04em;">
            SESI AKTIF
        </div>
...
def sidebar_user(label):
    ...
    st.markdown(f"""
    <div style="background:rgba(9,242,137,0.07);
                border-radius:8px;padding:8px 10px;
                display:flex;align-items:center;gap:8px;">

        <div style="width:26px;height:26px;border-radius:50%;
                    background:rgba(9,242,137,0.18);
                    display:flex;align-items:center;justify-content:center;
                    font-size:10px;color:#09F289;font-weight:500;">
            {initial}
        </div>
